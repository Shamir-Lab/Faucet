            ...
            for(int i = 0; i < 5; i++){
                ...
                if(contig){
                    ...
                    if(isLowCovContig(contig)){
                        ...
                        if (far_node){
                            if(far_node->numPathsOut() == 0){
                                if(far_node->contigs[4]){
                                    cutPath(far_node, 4);
                                }
